            ...
            @else
                <form method="POST" action="{{ url('/barang/'.$barang->barang_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="number" class="form-control" id="barang_beli" name="barang_beli" value="{{ old('barang_beli', $barang->barang_beli) }}" required>
                            @error('barang_beli')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            <input type="number" class="form-control" id="barang_jual" name="barang_jual" value="{{ old('barang_jual', $barang->barang_jual) }}" required>
                            @error('barang_jual')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
