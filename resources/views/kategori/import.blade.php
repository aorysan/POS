<form action="{{ url('/kategori/import_excel') }}" method="POST" id="form-import" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template.xlsx') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i>Download</a>
                </div>
                <div class="form-group">
    ...
    $(document).ready(function() {
        $("#form-import").validate({
            ...
            submitHandler: function(form) {
                formData = new FormData(form); // Jadikan form ke FormData untuk menghandle file
                $.ajax({
                    url: form.action,
                    type: form.method,
